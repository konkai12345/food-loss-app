...
void main() async {
  ...
  runApp(FoodLossAppNaturalComplete(notificationService: notificationService));
}

class FoodLossAppNaturalComplete extends StatelessWidget {
  final NotificationServiceSimple notificationService;

  const FoodLossAppNaturalComplete({Key? key, required this.notificationService}) : super(key: key);
